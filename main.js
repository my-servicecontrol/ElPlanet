...
function newOrder() {
  ...
  $("#commonModal .modal-body").html(function () {
    ...
    <div class="col-sm-5" id="allnum" name="allnum" type="text" style="color: blue; font-size: 14px; text-align: center;"></div>
<div class="col-sm-5" style="color: red; font-size: 12px; text-align: right; margin-bottom: 10px;"><i class="fas fa-pen"></i> Запись</div>
    </div>
    <div class="row">
    <div class="col-sm-5">
